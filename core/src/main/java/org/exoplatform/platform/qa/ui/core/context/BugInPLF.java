...
/**
 * All tests marked by this annotation are disabled because of a bug in eXo Platform.
 */
...
@Disabled
@Tag("BugInPLF")
public @interface BugInPLF {

  /**
   * The <em>ID</em> of the JIRA that references the bug in eXo Platform.
   */
  String value();
