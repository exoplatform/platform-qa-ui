...
public class exoTribeLocator {
  ...
  //SETTINGS
    ...
    public static final SelenideElement ELEMENT_TRIBE_EDIT_NOTIFICATIONS_GENERAL = $(byXpath("//*[contains(text(),'Someone joins the social intranet')]/following::button[1]"));
