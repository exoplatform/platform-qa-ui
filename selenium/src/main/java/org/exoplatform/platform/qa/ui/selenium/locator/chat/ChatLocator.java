...
public class ChatLocator {
  ...
  public static final String          ELEMENT_CHAT_UISTATUSPROFILEPORTLET             = ".//*[@id='UIStatusProfilePortlet']//*[@class='${icon}' and @data-original-title='${status}']";
  ...
  public static final SelenideElement ELEMENT_CHAT_BUTTON_SAVE_ADD_ROOM               = $(byXpath("//*[@id=\"chat-application\"]/div[1]/div[2]/div[4]/div[1]/div/div[2]/div[2]/button[1]"));

  public static final String          ELEMENT_CHAT_STATUS                             = "user-${status}";

  public static final By              ELEMENT_CHAT_ICON                               = byClassName("status-dropdown");

  public static final SelenideElement ELEMENT_CHAT_INPUT_ROOMUSERSS                   = $(byClassName("selectize-input")).find(by("type", "text"));
  ...
  public static final SelenideElement ELEMENT_CHAT_RESULT_SEARCH_USER                 = $(byAttribute("class", "selectize-dropdown multi"));
