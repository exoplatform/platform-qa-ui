...
public class TaskManagementLocator {
  ...
  // Task area
  public static final SelenideElement ELEMENT_BUTTON_ADD_TASK                       = $(byXpath("//*[@id=\"taskManagement\"]/div[2]/div[2]/div/div[2]/div/div[1]/div[1]/div[1]/a"));
  ...
  public static final SelenideElement ELEMENT_TASK_FORM_ICOND_DROP_DOWN_MENU        = $(byXpath("//*[@id=\"taskManagement\"]/div[3]/div[2]/div[1]/div/div[1]/div[1]/a[1]"));
  ...
  public static final String          ELEMENT_LEFT_PANEL_PROJECT_NAME               = ".//*[contains(@class,'project-name')][contains(.,'$project')]";

  // Project area-->Context Menu
  public static final SelenideElement ELEMENT_PROJECT_ICON_ADD_PROJECT              = $(byAttribute("data-id", "0")).parent().find(byClassName("addProject"));

  public static final SelenideElement ELEMENT_ADD_PROJECT                           = ELEMENT_PROJECT_ICON_ADD_PROJECT.parent().parent().find(byClassName("uiIconAddProject"));

  // Labels area
  public static final SelenideElement ELEMENT_LABEL_ICON_ADD_LABEL                  = $(byAttribute("data-labelid", "0")).parent().find(byClassName("addLabel"));
  ...
  // Add project form
  public static final By              ELEMENT_ADD_PROJECT_PARENT_PROJECT            = By.xpath("(.//*[contains(@class,'addProject')]//*[contains(@class,'hoverStatusBlock')])[1]");

  public static final String          ELEMENT_ADD_PROJECT_PARENT_PROJECT_DROP_MENU  = ".//*[contains(@class,'uiDropdownMenu')]//*[contains(text(),'$project')]";

  public static final By              ELEMENT_ADD_PROJECT_TITLE                     = By.xpath(".//*[contains(@class,'addProject')]//*[contains(@name,'name')]");

  public static final By              ELEMETN_ADD_PROJECT_ENABLE_CALENDAR_CHECKBOX  = By.xpath(".//*[contains(@class,'addProject')]//*[contains(@class,'checkbox')]");

  public static final SelenideElement ELEMENT_SAVE_PROJECT                          = $(byXpath("//*[@id=\"taskManagement\"]/div[4]/div/div[2]/form/div[7]/button[1]"));
  ...
  public static final SelenideElement ELEMENT_BUTTON_SAVE                           = $(byXpath("//*[@id=\"taskManagement\"]/div[4]/div/div[2]/div[7]/button[1]"));

  public static final SelenideElement ELEMETN_EDIT_PROJECT_ENABLE_CALENDAR_CHECKBOX = $(byClassName("uiCheckbox"));

  public static final SelenideElement ELEMENT_EDIT_PROJECT                          = $(byXpath("//*[@id=\"taskManagement\"]/div[4]/div/div[2]/div[2]/span/div/form/div/div[1]/div/input"));

  // Color
  public static final String          ELEMENT_COLOR_TABLE_ITEM                      = ".//*[contains(@class,'project-name')][contains(.,'$project')]/..//*[contains(@class,'$color')]";

  // Delete project
  public static final By              ELEMENT_DELETE_PROJECT_OPTION                 = byClassName("delete-project");
  ...
  // Labels-->General
  public static final SelenideElement ELEMENT_SAVE_EDIT_LABEL                       = $(byXpath("//*[@id=\"taskManagement\"]/div[4]/div/div[2]/div/div[2]/button[1]"));
  ...
  public static final SelenideElement ELEMENT_WORK_PLANED_FIELD                     = $(byClassName("addTask")).find(byClassName("date-work-plan")).find(byClassName("editableField"));
