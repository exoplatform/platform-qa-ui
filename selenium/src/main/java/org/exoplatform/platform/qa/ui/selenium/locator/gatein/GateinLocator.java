...
public final class GateinLocator {
  ...
  public static final By ELEMENT_ENABLE_SUBMIT_QUESTION = By.id("enableAnonymousSubmitQuestion");
  ...
  public static final By ELEMENT_MAIL_CONTENT_FRAME1 = By.id("EmailMoveQuestion___Frame");

  public static final By ELEMENT_MAIL_CONTENT_FRAME2 = By.xpath("//*[@id='xEditingArea']/iframe");
   ...
   ***************************************************************/
  public static final By ELEMENT_APPLICATION_REGISTRY_PORTLET = By.id("UIApplicationRegistryPortlet");
  ...
  public static final String
          ELEMENT_EDIT_PORTLET_DELETE_PERMISSION_ICON =
  ...
  public static final String
          ELEMENT_RIGHT_PANEL_ADD_APPLICATION_RADIOBTN =
          ".//*[contains(@id,'description')][text()='${des}']/../..//*[contains(@id,'label')][text()='${name}']/../..//input[@type='radio']";

  public static final String
          ELEMENT_RIGHT_PANEL_ADD_APPLICATION_NAME =
  ...
  public static final String
          ELEMENT_DETAIL_PORTLET_BREADCRUMB =
  ...
  public static final String
          ELEMENT_PORTLET_ACCESS_PERMISSION_DELETE_GROUP_BTN =
  ...
  public static final String
          ELEMENT_PORTLET_SELECT_PERMISSION_GROUP_MEMBERSHIP_NAME =
          ".//*[contains(@class,'PopupContent')]//*[@title='$name']";

  public static final String
          ELEMENT_PORTLET_ACCESS_PERMISSION_GROUP_NAME =
  ...
  public static final String
          ELEMENT_REMOTE_GADGET_TABLE_CATEGORIES_CHECKBOX =
  ...
  public static final String
          ELEMENT_REMOTE_GADGET_INFO_CATEGORY =
  ...
  public static final String
          ELEMENT_REMOTE_GADGET_LEFT_DELETE_BTN =
  ...
  public static final By ELEMENT_DASHBOARD_WORKSPACE_POPUP_CLOSE =
          By.xpath(
                  ".//*[contains(@class,'UIPopupWindow')]//*[contains(text(),'Dashboard Workspace')]/..//*[contains(@class,'uiIconClose')]");
  ...
  public static final String ELEMENT_MYDASH_GADGET_COLUMN = "//*[@class='UIColumn'][${number}]";
  ...
  public static final By ELEMENT_MYDASH_LOGINHISTORY_EDIT_HISTORYTAB_EARLIER = By.xpath("//*[text()='Earlier (15)']");
  ...
  // Permission selector
  public static final String
          ELEMENT_PERMISSION_SELECTOR_POPUP_GROUP =
          ".//*[contains(@class,'uiIconNode')][contains(@title,'${group}')]";

  public static final String
          ELEMENT_PERMISSION_SELECTOR_POPUP_MEMEBRSHIP =
  ...
  public static final By ELEMENT_NODE_SETTING_VISIBLE_CHECKED = By.cssSelector("#visible[checked='']");

  public static final By ELEMENT_NODE_SETTING_SWITCH_MODE_CHECKED = By.cssSelector("#switchmode[checked='']");
  ...
  // Step 2
  public static final By ELEMENT_PAGE_SELECT_LAYOUT_FORM = By.id("UIWizardPageSelectLayoutForm");
  ...
  public static final String ELEMENT_APPLICATION_CATEGORY = "//*[@title='${applicationCategor}']/i";
  ...
  public static final String ELEMENT_NAME_CONTAINER_PLF41 =
          ELEMENT_DRAG_CONTAINER_PLF41 + "/../*[text()='${nameContainer}']";
  ...
  public static final String
          ELEMENT_DRAG_CURRENT_CONTAINER =
          "//*[text()='${nameContainer}']/../*[@data-original-title='Hold this area to drag this container']";

  public static final By ELEMENT_PORTLET_LAYOUT_DECORATOR = By.className("portletLayoutDecorator");
  ...
  public static final String
          ELEMENT_EDIT_PERMISSION_SELECTOR_POPUP_GROUP =
          ".//*[@id='PermissionSelector']//*[contains(@class,'uiIconNode')][contains(@title,'${group}')]";

  public static final String
          ELEMENT_ADD_PERMISSION_SELECTOR_POPUP_GROUP =
          "//*[contains(@class,'uiIconNode')][contains(@title,'${group}')]";

  public static final String
          ELEMENT_EDIT_PERMISSION_MOVE_APPS_SELECT =
          "//*[contains(@id,'UIListMoveAppsPermissionSelector')]//*[contains(@title,'${group}')]";

  public static final String
          ELEMENT_EDIT_PERMISSION_MOVE_CONTAINERS_SELECT =
          "//*[contains(@id,'UIListMoveContainersPermissionSelector')]//*[contains(@title,'${group}')]";

  public static final String
          ELEMENT_ADD_PERMISSION_SELECTOR_POPUP_MEMEBRSHIP =
          "//*[contains(@id,'UIListPermissionSelector')]//*[contains(@title,'${member}')]";

  public static final String
          ELEMENT_EDIT_PERMISSION_SELECTOR_POPUP_MEMEBRSHIP =
          ".//*[@id='PermissionSelector']//*[contains(@title,'${member}')]";
  ...
  public static final String
          ELEMENT_VIEW_PROPERTIES_ACCESS_PERMISSTION_VALUE =
          ".//*[@id='PermissionGrid']//*[contains(text(),'${group}')]";

  public static final String
          ELEMENT_VIEW_PROPERTIES_GROUP_REMOVE_BTN =
          ".//*[@id='PermissionGrid']//*[contains(text(),'${group}')]/../..//*[contains(@class,'uiIconDelete')]";
  ...
  public static final String
          ELEMENT_DROP_SOURCE_HAS_LAYOUT_BY_NAME =
  ...
  public static final String
          ELEMENT_EDIT_CONTAINER_ICON_BY_NAME =
          "//span[contains(text(),'${name}')]/..//*[contains(@class,'uiIconEdit')]";

  public static final String
          ELEMENT_DELETE_CONTAINER_ICON_BY_NAME =
          "//span[contains(text(),'${name}')]/..//*[contains(@class,'uiIconTrash')]";
  ...
  public static final String
          ELEMENT_CONTAINER_PORTLET_APPLICATION =
  ...
  public static final String
          ELEMENT_MOVE_CONTAINERS_PERMISSION_SETTING =
          ".//*[@id='PermissionSetting']//a[contains(text(),'Move Containers')]";

  public static final String
          ELEMENT_SELECT_PERMISSION_BUTTON =
  ...
  public static final String
          ELEMENT_SELECTED_EDIT_PERMISSION_MEMBERSHIP =
  ...
  public static final String
          ELEMENT_EDITOR_PAGE_APPLICATION_PORTLET =
  ...
  // Application
  public static final String
          ELEMENT_EDIT_PORTLET_CATEGORY_APPLICATION_ARROW_RIGHT =
          "//*[@title='$category']/*[contains(@class,'uiIconArrowRight')]";

  public static final String
          ELEMENT_EDIT_PORTLET_CATEGORY_APPLICATION_ARROW_DOWN =
  ...
  public static final By ELEMENT_PAGE_EDITOR_SAVE_AND_CLOSE_BUTTON = By.xpath("//*[text()='Save And Close']");
   ...
   ***************************************************************/
  public static final String
          ELEMENT_GROUP_SELECT_ADD_NAVIGATION =
   ...
   * PORTAL MANAGE PAGES
   ***************************************************************/
  public static final By ELEMENT_MANAGEPAGES_TITLE = By.xpath(".//*[text()='Manage Pages']");
  ...
  public static final By ELEMENT_MANGEPAGES_INFORM_POPUP_CLOSE = By.xpath("//*[@title='Close Window']");

  public static final By ELEMENT_MANAGEPAGES_ADD_NEW_PAGE_BTN =
          By.xpath(".//*[@id='UIPageBrowser']//*[text()='Add New Page']");

  // Results search
  public static final String ELEMENT_MANAGEPAGES_CONTENT_TITLE_COLUMN = ".//*[contains(text(),'${title}')]";
  ...
  // Add new page popup
  public static final By ELEMENT_MANAGEPAGES_ADD_NEW_PAGES_POPUP_FORM = By.xpath(".//*[@id='UIPageForm']");
  ...
  public static final String
          ELEMENT_PAGE_DELETE_ICON =
          "//*[contains(@title,'${page}')]/../..//*[@class='uiIconDelete uiIconLightGray']";

  public static final String MESSAGE_DELETE_PAGE = "Do you want to delete this page?";
  ...
  // message
  public static final String ELEMENT_MSG_CREATE_ACCOUNT = "You have registered a new account.";

  public static final String ELEMENT_MSG_UPDATE_PROFILE = "The user profile has been updated.";
  ...
  public static final String ELEMENT_GROUP_MANAGEMENT_INFO = ".//*[contains(text(),'Group Info')]";

  public static final String
          ELEMENT_GROUP_MANAGEMENT_SELECT_GROUP =
  ...
  public static final String
          ELEMENT_ADDED_GROUP_USER_IN_TABLE1 =
          "//*[@id='UIGridUser']//span[contains(text(),'$mem')]/../../*[@headers='userName']/*[contains(.,'$user')]";

  public static final String
          ELEMENT_EDIT_USER_MEM_IN_TABLE_ICON =
  ...
  public static final String
          ELEMENT_MEMBERSHIP_DESCRIPTION =
  ...
  // Group management
  public static final String
          ELEMENT_USER_REMOVE_MEMBER_ICON =
  ...
  public static final String
          ELEMENT_USER_SOCIAL_NETWORKS_TAB_GOOGLE_ACCOUNT =
  ...
  public static final By ELEMENT_SITE_LAYOUT_CONTAINER_HOME_DELETE_ICON =
          By.xpath(
                  "//*[@id='RightBody']/div/div[2]/div/div[2]/a[2][@data-original-title='Delete Container']/i[@class='uiIconTrash uiIconWhite']");
  ...
  public static final By ELEMENT_SITE_LAYOUT_CONTAINER_NAVIGATION =
          By.xpath(
                  "//*[@class='UIRowContainer']//*[@class='portletLayoutDecorator' and contains(text(),'UIBreadCrumbsNavigationPortlet')]/ancestor::*[@class='LAYOUT-BLOCK LAYOUT-PORTLET']");

  public static final By ELEMENT_SITE_LAYOUT_CONTAINER_PARENT_EDIT_ICON =
          By.xpath(
                  ".//*[@id='Officebody']/div/div[2]/div/div[2]/a[1][@data-original-title='Edit Table']/i[@class='uiIconEdit uiIconWhite']");

  public static final String ELEMENT_SITE_LAYOUT_CONTAINER_BY_ID = "//*[@id='${id}']/div";

  public static final String
          ELEMENT_SITE_LAYOUT_CONTAINER_PARENT_EDIT_ID =
  ...
  public static final String ELEMENT_SITE_LAYOUT_CONTAINER_BY_ID_AND_CLASS = "//*[@id='${id}']//*[@class='${class}']";

  public static final String
          ELEMENT_SITE_LAYOUT_DOCUMENTS_CONTAINER_EDIT =
  ...
  public static final String
          ELEMENT_PERMISSION_SELECTOR_BUTTON =
  ...
  public static final By ELEMENT_CONTENT_DETAIL_CONTENT_BOX = By.xpath("//*[@class='uiContentBox']");

  public static final String
          ELEMENT_CONTENT_DETAIL_CONTENT_BOX_PREFERENCES_BTN =
  ...
  public static final By ELEMENT_CONTENT_LIST_CONTENT_BOX = By.xpath("//*[@class='uiContentBox']");
  ...
  public static final By ELEMENT_ADDNEWPAGE_DISPLAYNAME = By.xpath("//*[@id='i18nizedLabel']");
  ...
  public static final String ELEMENT_FOLDERSELECTOR_CONTENTLIST_FINALPATH = "//*[@class='Item' and text()='${name}']";

  public static final String ELEMENT_FOLDERSELECTOR_CONTENTDETAIL_FINALPATH =
          "//*[@class='OddItem']//*[text()='${name}']";

  // Content Detail Preference
  public static final By ELEMENT_CONTENTDETAILPREF_TABCONTENTDISPLAY = By.xpath("//*[@class='uiContentBox']");
  ...
  public static final String
          ELEMENT_PAGEEDITOR_EDITELEMENT_BY_ID =
