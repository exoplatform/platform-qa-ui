...
public class AnswerLocator {
  ...
  public static final By              ELEMENT_CATEGORY_DELETE_BUTTON                   = By.xpath("//*[@class='uiIconDeleteCategory']");
  ...
  public static final By              ELEMENT_CATEGORY_WATCH_OK_BUTTON                 = By.xpath("//*[contains(text(),'OK') and contains(@onclick,'answers')]");
  ...
  // Category list
  public static final String          ELEMENT_CATEGORY_LIST_ITEM                       = "//*[contains(@class,'faqCategory oncontextmenu')]//*[contains(.,'$category')]";
  ...
  public static final By              ELEMENT_CATEGORY_ADD_FORM_SAVE_BUTTON            = By.xpath("//*[@id='UICategoryForm']//*[text()='Save']");
  ...
  public static final By              ELEMENT_CATEGORY_OK_BUTTON                       = By.xpath("//*[contains(@class,'UIPopupWindow')]//a[text()='OK']");
  ...
  public static final By              ELEMENT_CATEGORY_DELETE_CONFIRM                  = By.xpath("//*[@id='UIForumPopupConfirmation']//*[contains(@class, 'confirmationIcon')]");

  public static final By              ELEMENT_CATEGORY_DELETE_OK_BUTTON                = By.xpath("//*[@id='UIForumPopupConfirmation']//*[text()='OK']");

  // Move category
  public static final By              ELEMENT_CATEGORY_MOVE_FORM                       = By.id("MoveCategoryForm");

  public static final String          ELEMENT_CATEGORY_MOVE_TARGET_ITEM                = "//*[@class='uiIconCategory uiIconLightGray']/../..//*[contains(.,'$category')]";

  // Permission tab
  public static final By              ELEMENT_CATEGORY_EDIT_PERM_TAB                   = By.xpath("//*[contains(@data-target,'PermissionTab')]");

  public static final String          ELEMENT_MANAGE_QUESTION_PERM_RESTRICTED          = "//*[contains(.,'$group')]/../td[2]/*[@class='uiCheckbox']/input[@type='checkbox']";

  public static final String          ELEMENT_MANAGE_QUESTION_PERM_MODERATOR           = "//*[contains(.,'$group')]/../td[3]/*[@class='uiCheckbox']/input[@type='checkbox']";

  public static final By              ELEMENT_SELECT_MEMBERSHIP_ICON                   = By.xpath("//*[@class='uiIconMembership uiIconLightGray']");

  public static final String          ELEMENT_SELECT_RIGHT_PARENT_GROUP                = "//*[contains(@id,'UIMemberShipSelector')]//a[contains(.,'$group')]";

  public static final By              ELEMENT_SELECT_MEMBERSHIP_POPUP                  = By.xpath("//*[contains(@id,'UIPopupWindow')]");

  // Permission
  public static final By              ELEMENT_CATEGORY_TAB_PERMISSIONS                 = By.xpath("//*[contains(@data-toggle,'tab')][contains(.,'Permissions')]");

  public static final By              ELEMENT_CATEGORY_USER_ICON_SELECTOR              = By.xpath("//*[contains(@class,'uiIconUser')]");

  public static final String          ELEMENT_CATEGORY_LIST_USER                       = ".//*[@id='UIListUsers']/*[contains(.,'$user')]";
  ...
  public static final String          ELEMENT_QUESTION_LIST_ITEM                       = "//*[@class='rightContent']//*[text()='$question']";

  public static final By              ELEMENT_MANAGE_QUESTION_BUTTON                   = By.xpath("//*[@class='uiIconAnsManageQuestion']");

  public static final String          ELEMENT_QUESTION_LINK                            = ".//*[contains(@class,'titleWithBorder')]//*[contains(text(),'$question')]";

  // Quick Search
  public static final By              ELEMENT_QUICK_SEARCH_INPUT                       = By.id("inputValue");

  public static final By              ELEMENT_QUICK_SEARCH_BUTTON                      = By.xpath("//*[@class='uiIconSearch uiIconLightGray']");

  public static final By              ELEENT_QUICK_SEARCH_POPUP                        = By.id("UIResultQuickSearchs");

  public static final String          ELEMENT_QUICK_SEARCH_CLOSE                       = "//*[@id=\"UIResultQuickSearchs\"]/div/div[2]/button";

  public static final String          ELEMENT_QUICK_SEARCH_ADVANCE_SEARCH_BUTTON       = "//*[@id='UIResultQuickSearchs']//*[text()='Advanced Search']";
  ...
  public static final String          ELEMENT_ADVANCE_SEARCH_ADVANCE_SEARCH_BUTTON     = "//*[@id='AdvanceSearchForm']//*[text()='Search']";

  public static final String          ELEMENT_ADVANCE_SEARCH_ADVANCE_CLOSE_BUTTON      = "//*[@id='AdvanceSearchForm']//*[text()='Close']";
  ...
  public static final By              ELEMENT_MANAGE_QUESTION_CLOSE_BUTTON             = By.xpath("//*[@id='UIAnswersPopupAction']//*[text()='Close']");
  ...
  public static final By              ELEMENT_SUBMIT_QUESTION_FORM_ATTACHMENT_BUTTON   = By.xpath("//*[@class='uiIconAttach uiIconLightGray']");
  ...
  public static final By              ELEMENT_SUBMIT_QUESTION_FORM_SAVE_BUTTON         = By.xpath("//*[@id='UIQuestionForm']//*[text()='Save']");

  public static final By              ELEMENT_SUBMIT_QUESTION_FORM_CANCEL_BUTTON       = By.xpath("//*[@id='UIQuestionForm']//*[text()='Cancel']");

  public static final By              ELEMENT_QUESTION_FILE_INPUT                      = By.xpath("//*[@name='file']");

  // Attach file form
  public static final By              ELEMENT_ATTACH_SAVE_BUTTON                       = By.xpath("//form[@id='UIAttachmentForm']//*[text()='Save']");
  ...
  public static final String          ELEMENT_QUESTION_EDIT                            = "//*[@id=\"{idEdit}Context\"]/li[3]/a";

  public static final SelenideElement ELEMENT_QUESTION_DELETE                          = $(byId("UIQuestions")).find(byClassName("uiIconTrash"));
  ...
  public static final By              ELEMENT_QUESTION_DELETE_FORM_OK_BUTTON           = By.xpath("//*[@id='UIDeleteQuestion']//*[text()='OK']");

  public static final By              ELEMENT_QUESTION_DELETE_FORM_CANCEL_BUTTON       = By.xpath("//*[@id='UIDeleteQuestion']//*[text()='Cancel']");
  ...
  public static final By              ELEMENT_ANSWER_FORM_SAVE_BUTTON                  = By.xpath(".//*[@id='UIResponseForm']//button[1]");
  ...
  public static final By              ELEMENT_ANSWER_DELETE_FORM_OK_BUTTON             = By.xpath("//*[@id='UIForumPopupConfirmation']//*[text()='OK']");
   ...
   ****************************************************/
  // Comment form
  public static final By              ELEMENT_COMMENT_BUTTON                           = By.xpath("//*[@class='questionAction']//*[text()='Comment']");

  public static final By              ELEMENT_COMMENT_FORM                             = By.id("UICommentForm");

  public static final By              ELEMENT_COMMENT_FORM_SAVE_BUTTON                 = By.xpath("//*[@id='UICommentForm']//*[text()='Save']");

  public static final String          ELEMENT_COMMENT_CONTENT                          = "//*[@class='responseContainer']//*[contains(@id,'Comment')]//*[text()='$comment']";
  ...
  public static final By              ELEMENT_COMMENT_DELETE_FORM_OK_BUTTON            = By.xpath("//*[@id='UIForumPopupConfirmation']//*[text()='OK']");
  ...
  public static final By              ELEMENT_COMMENT_MORE_ACTION                      = byClassName("uiDropdownWithIcon");

  public static final By              ELEMENT_COMMENT_EDIT                             = byClassName("uiIconEdit");
