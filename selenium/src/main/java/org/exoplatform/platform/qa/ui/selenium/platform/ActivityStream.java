...
import static org.exoplatform.platform.qa.ui.selenium.locator.onlyOffice.OnlyOfficeLocator.ELEMENT_EDIT_ONLINE_BUTTON_FROM_PREVIEW;
...
public class ActivityStream {
  ...
  public void replyToCommentDW(String comment, String reply, String user) {
  ...
  public void replyToCommentByOtherUserDW(String comment, String reply, String user) {
  ...
  public void deleteReplyDW(String comment, String reply) {
  ...
  public void likeCommentDW(String activity, String comment) {
    ...
    $(By.id(ELEMENT_INCON_LIKE_COMMENT.replace("{id}", idBlocComment))).waitUntil(visible, openBrowserTimeoutMs).click();
    $(By.id(ELEMENT_INCON_LIKE_COMMENT.replace("{id}", idBlocComment))).find(By.className("commentLiked")).waitUntil(visible, openBrowserTimeoutMs);

  }

  public void dislikeCommentDW(String activity, String comment) {
    ...
    $(By.id(ELEMENT_INCON_LIKE_COMMENT.replace("{id}", idBlocComment))).waitUntil(visible, openBrowserTimeoutMs).click();
    $(By.id(ELEMENT_INCON_LIKE_COMMENT.replace("{id}", idBlocComment))).find(By.className("commentLiked")).waitUntil(Condition.not(exist), openBrowserTimeoutMs);
