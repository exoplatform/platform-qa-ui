...
public final class ActivityStreamLocator {
    ...
    public static final By              ELEMENT_SPACE_MENU_MORE_BTN                          =
            By.xpath(".//*[@class='uiIconAppMoreButton']");

    public static final String          ELEMENT_SPACE_MENU_APPLICATION_PORTLET               =
            ".//*[@id='spaceMenuTab']//*[contains(text(),'${app}')]";

    // Composer
    public static final By              ELEMENT_COMPOSER_INPUT_FILED                         =
    ...
    public static final By              ELEMENT_COMPOSER_FILE_ATTACHMENT_ACTIVITY            =
            By.cssSelector(".uiActivityFileAttachment");

    public static final By              ELEMENT_SELECT_FILE_POPUP                            =
            By.xpath("//span[text()='Select File']");
    ...
    public static final String          ELEMENT_ACTIVITY_AUTHOR_ACTIVITY                     =
    ...
    public static final String          ELEMENT_DRIVER_OPTION_2                              =
            ".//*[@id='DriveTypeDropDown']//li[$num]";

    public static final By              ELEMENT_DRIVES_LIST                                  =
            By.xpath(".//*[@id='DriveTypeDropDown']");

    // Task/Event activity
    public static final String          ELEMENT_ACTIVITY_TASK_EVENT_TITLE                    =
            "//*[@class='linkTitle' and text()='$name']";

    public static final String          ELEMENT_ACTIVITY_TASK_EVENT_TITLE_SPACE_AS_LINK      =
            ".//*[contains(@href,'${space}')][contains(text(),'${event}')]";

    public static final String          ELEMENT_ACTIVITY_TASK_EVENT_START_DATE_MONTH         =
            ".//*[contains(text(),'${name}')]/../..//*[contains(@class,'heading')][contains(text(),'${month}')]";

    public static final String          ELEMENT_ACTIVITY_TASK_EVENT_START_DATE_DAY           =
            ".//*[contains(text(),'${name}')]/../..//*[contains(@class,'content')][contains(text(),'${day}')]";

    public static final String          ELEMENT_ACTIVITY_TASK_EVENT_DESCRIPTION              =
            "//*[@class='linkTitle' and text()='$name']/../..//*[text()='$description ']";

    public static final String          ELEMENT_ACTIVITY_TASK_EVENT_DATE                     =
    ...
    public static final String          ELEMENT_ACTIVITY_TASK_EVENT_COMMENT_ITEM             =
    ...
    public static final String          ELEMENT_ACTIVITY_TASK_COMMENT_ATTACHMENT             =
            "Attachment(s) has been added to the task";
    ...
    public static final String          ELEMENT_QUESTION_ACTIVITY_ANSWER_NUMBER              =
    ...
    public static final String          ELEMENT_QUESTION_ACTIVITY_COMMENT_NUMBER             =
    ...
    public static final String          ELEMENT_QUESTION_ACTIVITY_COMMENT_CONTENT            =
    ...
    public static final String          ELEMENT_QUESTION_ACTIVITY_ANSWER_ICON                =
    ...
    public static final String          ELEMENT_ACTIVITY_COMMOM_CHECK_COMMENT_OF_ACTIVITY    =
            ".//*[contains(text(),'${title}')]/../../../../..//*[contains(text(),\"${comment}\")]";
    ...
    public static final String          ELEMENT_ACTIVITY_EDIT_A_NODE                         =
    ...
    public static final String          ELEMENT_ACTIVITY_VERSION                             =
    ...
    public static final String          ELEMENT_PUBLICATION_LASTCOMMENT                      =
    ...
    public static final String          ELEMENT_PUBLICATION_FIRSTPOST_AUTHOR                 =
    ...
    public static final String          ELEMENT_ACTIVITY_LINK                                =
            "//*[@id='boxContainer']//*[contains(text(),'${title}')]/../..//*[contains(@onclick,'${link}')]";

    public static final String          ELEMENT_ACTIVITY_LINK_USER_ICON                      =
            "//*[@class='activityAvatar avatarCircle']/*[contains(@href,'${user}')]/../..//*[@class='uiIconSocLinkMini uiIconSocWhite']";

    public static final String          ELEMENT_ACTIVITY_MENTION_USER                        =
    ...
    public static final String          ELEMENT_ACTIVITY_DOCUMENT_MEDIA_VIEW_LINK            =
            ".//*[contains(@data-original-title,'${nameFile}')]/../../../..//i[@class='uiIconWatch uiIconLightGray']";

    public static final String          ELEMENT_ACTIVITY_EMBBED_MEDIA_VIEW_LINK              =
            ".//*[contains(@href,'${linkFile}')]/../../../..//i[@class='uiIconWatch uiIconLightGray']";

    public static final String          ELEMENT_ACTIVITY_WEBCONTENT_VIEW_LINK                =
            ".//a[@title='${nameContent}']/../../../..//i[@class='uiIconWatch uiIconLightGray']";

    public static final String          ELEMENT_ACTIVITY_DOCUMENT_MEDIA_DOWNLOAD_BTN         =
    ...
    public static final String          ELEMENT_ACTIVITY_TOPIC_REPLY                         =
    ...
    public static final String          ELEMENT_ACTIVITY_SPACE_AUTHOR                        =
            "//*[contains(text(),'${title}')]/../*[contains(@class,'heading')]/*[contains(@class,'author')]";

    public static final String          ELEMENT_ACTIVITY_USER_ACTIVITY_DELETE_BTN            =
            "//*[contains(text(),'${title}')]/../*[contains(@class,'heading')]/*[contains(@class,'uiIconClose uiIconLightGray controllDelete')]";

    // Arrow menu Activity
    public static final By              ELEMENT_ACTIVITY_ARROWDOWN_MENU                      =
            By.xpath("//*[contains(@class,'MiniArrowDown')]");
    ...
    public static final By              ELEMENT_ACTIONS_ZOOM_IN_BTN                          =
            By.cssSelector(".uiIconSimplePlusMini");
    ...
    public static final By              ELEMENT_READER_FILE_CONTENT_PAGE_1                   =
            By.xpath("//*[@id='viewerContainer']");
    ...
    public static final String          ELEMENT_RIGHT_PANEL_PROFILE_AVATAR                   =
            ".//*[contains(@class,'avatarMedium ')]//img[contains(@alt,'${fullName}')]";

    public static final String          ELEMENT_RIGHT_PANEL_PROFILE_NAME_LINK                =
    ...
    public static final By              ELEMENT_PEVIEW_MODE_NOT_AVAIABLE_ICON                =
    ...
    public static final String          ELEMENT_COMMENT_AREA_TOP_FULL_NAME                   =
    ...
    public static final String          ELEMENT_COMMENT_AREA_TOP_ACTIVITY_TITLE_TRUNCATED    =
    ...
    public static final String          ELEMENT_COMMENT_AREA_TOP_LIKE_NUMBER                 =
    ...
    public static final By              ELEMENT_COMMENT_INPUT_PLACEHOLDER                    =
            By.xpath(".//*[@placeholder='Add your comment...']");

    public static final By              ELEMENT_COMMENT_BOX                                  =
            By.xpath(".//*[@id='commentTextAreaPreview']");

    public static final String          ELEMENT_COMMENT_CONTENT                              =
            ".//*[@class='cont'][contains(text(),'${text}')]";

    public static final By              ELEMENT_COMMENT_EMPTY                                =
            By.xpath(".//*[text()='No comment yet']");
    ...
    // Activity of file
    public static final String          ELEMENT_ACTIVITY_FILE_TITLE                          =
    ...
    public static final String ELEMENT_REPLY_INPUT="InputContainer1{id}";
    ...
    public static final String REMOVE_IMAGE_LINK = "//*[@id=\"{id}\"]/div[3]/a";
}
