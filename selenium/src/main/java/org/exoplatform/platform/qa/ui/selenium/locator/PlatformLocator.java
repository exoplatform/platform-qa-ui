...
public final class PlatformLocator {
  ...
  public static final String
                             ELEMENT_GMAIL_CONTENT              =
          ".//span[contains(.,'\"${title}\" page was modified') or contains(.,'${title}')]";

  public static final By ELEMENT_GMAIL_SIGN_IN_LINK = By.xpath("//a[@id='gmail-sign-in' and contains(text(),'Sign in')]");
  ...
  //Membership popup
  public static final String
                         ELEMENT_GROUP_MEMBERSHIP_NAME_SELECT =
