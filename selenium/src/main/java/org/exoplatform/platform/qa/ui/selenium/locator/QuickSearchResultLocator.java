...
public final class QuickSearchResultLocator {
  ...
  public static final String
          ELEMENT_QUICKSEARCHRESULT_ICONDOC =
          "//*[@class='uiIcon64x64TemplateFolderDefault uiIcon64x64Templateacme_product']/../..//*[text()='${title}']";

  public static final By ELEMENT_QUICKSEARCHRESULT_SEE_ALL_SEARCH =
          By.xpath(".//*[@class='message']/*[contains(text(),'See All Search Results')]");

  // filter box
  public static final By ELEMENT_SEARCHRESULT_ALLTYPECHECK =
          By.xpath("//*[@value='all' and @name='contentType' and @checked='checked']");

  public static final By ELEMENT_SEARCHRESULT_FILESTYPECHECK =
          By.xpath("//*[@value='file' and @name='contentType']");
  ...
  public static final By ELEMENT_SEARCHRESULT_DISCTYPECHECK =
          By.xpath("//*[@value='post' and @name='contentType']");
  ...
  public static final By ELEMENT_SEARCHRESULT_WIKITYPECHECK =
          By.xpath("//*[@value='wiki' and @name='contentType']");
  ...
  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_TASK_DUEDATE =
          ".//*[@id='result']//*[contains(text(),'${name}')]/../../..//*[contains(text(),'Due for')]";

  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_TASK_ICON =
  ...
  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_EVENT_DUEDATE =
          ".//h6//*[contains(text(),'${name}')]/../..//*[contains(.,'${date}')]";

  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_EVENT_ICON =
          ".//h6//*[contains(text(),'${name}')]/../../../../..//*[@class='avatar pull-left']";

  // Searched results page-->file
  public static final String ELEMENT_SEARCHRESULT_CONTENT_FILE_TITLE = ".//*[contains(text(),'${name}')]";

  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_FILE_LOCATION =
          "//*[contains(text(), '${name}')]/../..//*[contains(text(),'${location}')]";

  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_FILE_ICON =
          ".//*[contains(text(),'${name}')]/../../..//*[@class='avatar pull-left ']";

  // Searched results page -->document
  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_DOC_ICON =
          ".//h6//*[contains(text(),'${name}')]/../../..//*[@class='avatar pull-left']";

  public static final String ELEMENT_SEARCHRESULT_CONTENT_DOC_TITLE = ".//h6//*[contains(text(),'${name}')]";

  // Searched results page -->discussion
  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_DISCUSSIONS_ICON =
          ".//*[contains(text(),'${name}')]/../../..//*[@class='uiIconApp64x64Forum']";

  public static final String ELEMENT_SEARCHRESULT_CONTENT_DISCUSSIONS_POST_TITLE = "//*[contains(text(),'${name}')]";

  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_DISCUSSIONS_EXCERPT =
          ".//*[contains(text(),'${name}')]/../../..//*[@class='excerpt']";

  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_DISCUSSIONS_FORUM_NAME =
          ".//*[contains(text(),'${topic}')]/../../..//*[@class='detail'][contains(text(),'${forum}')]";

  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_DISCUSSIONS_POST_DATE =
          ".//*[contains(text(),'${topic}')]/../../..//*[@class='detail'][contains(text(),'${date}')]";

  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_DISCUSSIONS_RATING =
          ".//*[contains(text(),'${topic}')]/../../..//*[@class='avgRatingImages clearfix']";

  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_DISCUSSIONS_NUMBER_REPLY =
          ".//*[contains(text(),'${topic}')]/../../..//*[@class='detail'][contains(text(),'${number}')]";

  // Searched results page --> wiki
  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_WIKI_ICON =
          ".//h6//*[contains(text(),'${name}')]/../../../../..//*[@class='avatar pull-left']";

  public static final String ELEMENT_SEARCHRESULT_CONTENT_WIKI_TITLE = ".//h6//*[contains(text(),'${name}')]";

  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_WIKI_LAST_MODIFICATION_DATE =
          ".//h6//*[contains(text(),'${name}')]/../../../../..//*[contains(text(),'${date}')]";

  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_WIKI_LOCATION =
          ".//h6//*[contains(text(),'${name}')]/../../../../..//*[contains(text(),'${location}')]";

  // Searched results page --> Spaces
  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_SPACE_AVATAR =
          ".//h6//*[contains(text(),'${name}')]/../../..//*[@class='avatar pull-left userThumbnail']";

  public static final String ELEMENT_SEARCHRESULT_CONTENT_SPACE_TITLE = ".//h6//*[contains(text(),'${name}')]";

  public static final String ELEMENT_SEARCHRESULT_CONTENT_SPACE_DESCRIPTION = ".//p[contains(text(),'${des}')]";

  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_SPACE_MEMBER_COUNT =
          ".//*[contains(text(),'${name}')]/../..//*[contains(text(),'${number}')]";

  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_SPACE_STATUS =
          ".//*[contains(text(),'${name}')]/../..//*[contains(text(),'${status}')]";

  // Searched results page --> People
  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_USER_AVATAR =
          ".//h6[contains(.,'${fullname}')]/../..//*[@class='avatar pull-left userThumbnail']";

  public static final String ELEMENT_SEARCHRESULT_CONTENT_USER_FULL_NAME = ".//h6[contains(.,'${fullname}')]";

  public static final String ELEMENT_SEARCHRESULT_CONTENT_USER_TITLE =
          ".//h6[contains(.,'${fullname}')]/../..//*[@class='excerpt']";

  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_USER_EMAIL =
          ".//h6[contains(.,'${fullname}')]/../..//*[@class='detail'][contains(.,'${email}')]";

  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_USER_GENDER =
          ".//h6[contains(.,'${fullname}')]/../..//*[@class='detail'][contains(text(),'${gender}')]";

  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_USER_PHONE =
          ".//h6[contains(.,'${fullname}')]/../..//*[@class='detail'][contains(text(),'${phone}')]";

  // Page searched results-->pages
  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_PAGE_ICON =
  ...
  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_PAGE_EXCERPT =
          ".//*[@id='result']//h6//*[contains(text(),'${page}')]/../../..//*[@class='excerpt']";

  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_PAGE_SITE_BELONGS_TO =
          ".//*[@id='result']//h6//*[contains(text(),'${page}')]/../../..//*[contains(text(),'${site}')]";

  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_PAGE_SITE_URL =
  ...
  public static final String ELEMENT_SEARCHRESULT_CONTENT_ANSWER_TITLE = ".//h6//*[contains(text(),'${name}')]";

  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_ANSWER_ICON =
          ".//h6//*[contains(text(),'${name}')]/../../../..//*[@class='avatar pull-left']";

  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_ANSWER_EXCERPT =
          ".//h6//*[contains(text(),'${name}')]/../../..//*[@class='excerpt']";

  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_ANSWER_NUMBER_REPLY =
          ".//h6//*[contains(text(),'${name}')]/../../..//*[contains(text(),'${number}')]";

  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_ANSWER_NUMBER_COMMENTS =
          ".//h6//*[contains(text(),'${name}')]/../../..//*[contains(text(),'${comment}')]";

  public static final String
          ELEMENT_SEARCHRESULT_CONTENT_ANSWER_RATING =
