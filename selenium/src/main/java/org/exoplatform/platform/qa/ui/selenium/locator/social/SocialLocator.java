...
public final class SocialLocator {
  ...
  public static final String
          ELEMENT_GMAIL_FORMAT_CONTENT =
          ".//strong//*[contains(text(),'$fullName')]/../../..//*[contains(.,'$content')]";

  public static final String
          ELEMENT_GMAIL_FORMAT_CONTENT_CONNECTION_REQUEST =
          "//*[contains(@href,'$username')]/../..//*[contains(.,'$content')]";

  public static final String
          ELEMENT_GMAIL_FORMAT_CONTENT_SPACE_REQUEST =
          "//*[contains(@href,'$username')]/../..//*[contains(.,'$content')]//a[contains(text(),'$space')]";

  public static final String
          ELEMENT_GMAIL_FORMAT_CONTENT_SPACE_POST_IN_MYSPACE =
          "//*[contains(@href,'$username')]/../../..//*[contains(.,'$content')]//a[contains(text(),'$space')]";

  public static final String
          ELEMENT_GMAIL_FORMAT_CONTENT_SPACE_INVITATION =
  ...
  public static final String
          ELEMENT_GMAIL_POST_IN_ACTIVITY_STREAM =
  ...
  public static final String
          ELEMENT_GMAIL_TITLE_POST_IN_SPACE_AS =
  ...
  public static final String
          ELEMENT_GMAIL_CONTENT_POST_IN_SPACE_AS_1 =
  ...
  public static final String
          ELEMENT_ACTIVITY_COMMENT_HIGHLIGHT =
  ...
  public static final String
          ELEMENT_ACTIVITY_UPLOAD_FILE_NAME =
  ...
  public static final String
          ELEMENT_ACTIVITY_TOPIC_REPLY_NUMBER =
  ...
  public static final By ELEMENT_NOTIFICATION_POP_UP = By.id("NotificationPopup");
  ...
  public static final String
          ELEMENT_INTRANET_NOTIFICATION_REMOVE_ICON =
  ...
  public static final String
          ELEMENT_NOTIFICATION_ALL_PAGE_REQUEST_JOIN_SPACE =
  ...
  // comment
  public static final String
          ELEMENT_INTRANET_NOTIFICATION_COMMENTS_CONTENT =
          ".//*[@id='NotificationPopup']//*[contains(@class,'status')][contains(.,'$comment')]";

  public static final String
          ELEMENT_INTRANET_NOTIFICATION_ACTIVITY_TITLE =
          ".//*[@id='NotificationPopup']//*[@class='content'][contains(.,'$title')]";

  public static final String
          ELEMENT_INTRANET_NOTIFICATION_ACTIVITY_COMMENT_HIGHLIGHT =
          ".//*[@class='contentComment'][contains(.,'$comment')]/../../..[contains(@style,'rgb(240, 240, 240)')]";

  public static final String
          ELEMENT_INTRANET_NOTIFICATION_ACTIVITY_COMMENT_CONTENT =
          ".//*[@class='contentComment'][contains(.,'$comment')]";

  public static final String
          ELEMENT_COMMENT_HIGHLIGHTED =
          "//*[@style = 'background-color: rgb(240, 240, 240);']//*[contains(text(),'${comment}')]";

  public static final String
          ELEMENT_COMMENT_ACTIVITY_VIEWER =
          "//*[contains(text(),'${comment}')]/../..//*[@class='author']/*[contains(@href,'${userName}')]";

  // Connection
  public static final String
          ELEMENT_CONNECT_NOTIFICATION =
          "//*[contains(text(),'${fullName}')]/../..//*[contains(.,'wants to connect with you')]";

  public static final String
          ELEMENT_CONNECT_ACCEPT_BUTTON =
          ".//*[contains(text(),'$name')]/../..//*[contains(@class,'action-item')]";

  public static final String
          ELEMENT_CONNECT_REFUSE_BUTTON =
  ...
  public static final String
          ELEMENT_MSG_SPACE_INVITATION_CLICK_ON_NOTIFICATION =
          "You are invited to join the space ${space} by the administrator.";

  // Request to join space
  public static final String
          ELEMENT_REQUEST_JOIN_SPACE_JUST_NOW =
  ...
  public static final String
          ELEMENT_REQUEST_JOIN_SPACE_NO_TIME =
  ...
  // Detail an activity
  public static final String
          ELEMENT_INTRANET_NOTIFICATION_DETAIL_ACTIVITY_DES =
  ...
  public static final By ELEMENT_NOTIFICATION_SENDER_ERROR_MESSAGE_INVALID_EMAIL =
          By.xpath(
                  ".//*[@id='confirmMessage']//*[contains(text(),'Cannot update the sender information: empty value or the format is not correct.')]");

  public static final String
          ELEMENT_NOTIFICATION_SENDER_SUCCESS_MESSAGE =
  ...
  public static final By ELEMENT_MY_NOTIFICATION_SETTING_FORM = By.id("uiNotificationSetting");
  ...
  public static final By ELEMENT_MENTION_SELECTED_BOX_MAIL_ICON_ANY =
          By.xpath(
                  "//*[@id='ActivityMentionPlugin']/../..//*[contains(@class,'status-true')]//*[@class='the-selectBox']//*[@class='uiIconPLFMail']");

  public static final String
          ELEMENT_LIKE_SELECTED_BOX_MAIL_ICON =
          "//*[@id='LikePlugin']/../..//*[contains(@class,'status-true')]//*[@class='the-selectBox']//*[@class='uiIconPLFMail']/..//*[contains(text(),'$option')]";

  public static final String
          ELEMENT_POST_SELECTED_BOX_MAIL_ICON =
  ...
  public static final By ELEMENT_POST_SPACE_SELECTED_BOX_MAIL_ICON_ANY =
          By.xpath(
                  "//*[@id='PostActivitySpaceStreamPlugin']/../..//*[contains(@class,'status-true')]//*[@class='the-selectBox']//*[@class='uiIconPLFMail']");

  // My notification setting-->Checked box email notification
  public static final By ELEMENT_NEW_USER_MAIL_ICON =
          By.xpath(
                  "//*[@id='NewUserPlugin']/../..//*[contains(@class,'status-true')]//*[@class='the-checkbox']//*[@class='uiIconPLFMail']");

  public static final By ELEMENT_CONNECTION_REQ_MAIL_ICON =
          By.xpath(
                  "//*[@id='RelationshipReceivedRequestPlugin']/../..//*[contains(@class,'status-true')]//*[@class='the-checkbox']//*[@class='uiIconPLFMail']");

  public static final By ELEMENT_COMMENT_MAIL_ICON =
          By.xpath(
                  "//*[@id='ActivityCommentPlugin']/../..//*[contains(@class,'status-true')]//*[@class='the-checkbox']//*[@class='uiIconPLFMail']");

  public static final By ELEMENT_MENTION_MAIL_ICON =
          By.xpath(
                  "//*[@id='ActivityMentionPlugin']/../..//*[contains(@class,'status-true')]//*[@class='the-checkbox']//*[@class='uiIconPLFMail']");

  public static final By ELEMENT_LIKE_MAIL_ICON =
          By.xpath(
                  "//*[@id='LikePlugin']/../..//*[contains(@class,'status-true')]//*[@class='the-checkbox']//*[@class='uiIconPLFMail']");

  public static final By ELEMENT_POST_MAIL_ICON =
          By.xpath(
                  "//*[@id='PostActivityPlugin']/../..//*[contains(@class,'status-true')]//*[@class='the-checkbox']//*[@class='uiIconPLFMail']");

  public static final By ELEMENT_INVITATION_SPACE_MAIL_ICON =
          By.xpath(
                  "//*[@id='SpaceInvitationPlugin']/../..//*[contains(@class,'status-true')]//*[@class='the-checkbox']//*[@class='uiIconPLFMail']");

  public static final By ELEMENT_JOIN_REQ_SPACE_MAIL_ICON =
          By.xpath(
                  "//*[@id='RequestJoinSpacePlugin']/../..//*[contains(@class,'status-true')]//*[@class='the-checkbox']//*[@class='uiIconPLFMail']");

  public static final By ELEMENT_POST_SPACE_MAIL_ICON =
          By.xpath(
                  "//*[@id='PostActivitySpaceStreamPlugin']/../..//*[contains(@class,'status-true')]//*[@class='the-checkbox']//*[@class='uiIconPLFMail']");
  ...
  public static final By ELEMENT_CONNECTION_REQ_INTRANET_ICON =
          By.xpath(
                  "//*[@id='RelationshipReceivedRequestPlugin']/../..//*[contains(@class,'status-true')]//*[@class='uiIconPLFWeb']");
  ...
  public static final By ELEMENT_SWITCH_ONOFF_EMAIL_ON_AND_LABEL =
          By.xpath(
                  "//*[@class='uiSwitchBtn']/*[@name='channelMAIL_CHANNEL'][contains(@checked,'checked')]/../../..//*[contains(text(),'Notify me by email')]");

  public static final By ELEMENT_SWITCH_ONOFF_WEB_ON_AND_LABEL =
          By.xpath(
                  "//*[@class='uiSwitchBtn']/*[@name='channelWEB_CHANNEL'][contains(@checked,'checked')]/../../..//*[contains(text(),'Notify me on-site')]");
  ...
  public static final By ELEMENT_TABLE_FOLLOWING_SWITCH_ONOFF =
          By.xpath(
                  "//*[@class='uiSwitchBtn']/*[@name='channelWEB_CHANNEL']/../../../../../..//following::*//*[contains(@class,'table-striped')]");
  ...
  // Categories
  public static final String
          ELEMENT_MYNOTIFICATION_SETTING_GROUP =
  ...
  public static final String
          ELEMENT_NAME_OF_PROFILE_TOP_LEFT =
          "//*[@id='UIBreadCrumbsNavigationPortlet']//*[contains(text(),'${name}')]";

  public static final String
          ELEMENT_NAME_OF_USER_TOP_LEFT =
          "//*[@id='UIBreadCrumbsNavigationPortlet']//*[contains(text(),'{$name}')]";

  public static final String
          ELEMENT_NAME_OF_USER_TOP_RIGHT =
  ...
  public static final String
          ELEMENT_UIEXPERIENCE_PROFILE_PORTLET =
  ...
  public static final By ELEMENT_CONTACT_GENDER_SELECTION = By.name("gender");
  ...
  public static final String
          ELEMENT_CONTACT_PHONE_REMOVE_ICON =
  ...
  public static final String
          ELEMENT_CONTACT_URL_REMOVE_ICON =
  ...
  public static final By ELEMENT_CHOOSE_AVATAR_IMAGE = By.className("fileNameLabel");
  ...
  // Connection part
  public static final String
          ELEMENT_UIMINICONNECTIONS_PORTLET_TEXT =
  ...
  public static final String
          ELEMENT_SPACE_MENU_DISPLAYORDER_ID =
          ".//*[@id='spaceMenuTab']/li[${number}]//*[contains(@class,'${tab}')]";

  public static final String
          ELEMENT_SPACE_MENU_DISPLAYORDER =
  ...
  public static final String
          ELEMENT_MY_SPACE_SEARCH_RESULT_NUMBER =
  ...
  public static final String
          ELEMENT_MY_SPACE_INVITATION_RECEIVED_ACCEPT_BTN =
          ".//*[contains(text(),'${space}')]/../../..//button[text()='Accept']";

  public static final String
          ELEMENT_MY_SPACE_INVITATION_RECEIVED_CANCEL_BTN =
  ...
  public static final String
          ELEMENT_MY_SPACE_ALL_SPACES_REQUEST_TO_JOIN_BTN =
          ".//*[contains(text(),'${space}')]/../../..//button[text()='Request to Join']";

  public static final String
          ELEMENT_MY_SPACE_ALL_SPACES_JOIN_BTN =
          ".//*[contains(text(),'${space}')]/../../..//button[text()='Join']";

  public static final String
          ELEMENT_MY_SPACE_ALL_SPACES_REQUEST_PENDING =
  ...
  public static final By ELEMENT_SPACE_GOSETTINGS = By.xpath("//*[@id='settings']");

  public static final By ELEMENT_SPACE_TEXTBOX_USER = By.xpath("//*[@id='user']");
  ...
  public static final String
          ELEMENT_REQUEST_TO_JOIN_SPACE_BTN =
          "//*[contains(text(),'${space}')]/../../..//button[text()='Request to Join']";
  ...
  public static final By ELEMENT_INPUT_SEARCH_USER_NAME = By.id("Quick Search");
  ...
  public static final String
          ELEMENT_APPLICATION_TAB_APPLICATION_LIST_CONTENT =
          ".//*[@id='UISpaceApplication']//strong[contains(text(),'${app}')]";

  public static final String
          ELEMENT_APPLICATION_TAB_APPLICATION_DELETE_BTN =
  ...
  public static final String ELEMENT_ADD_APPLICATION_POPUP_CATEGOGY = ".//*[@id='${category}']";

  public static final String
          ELEMENT_ADD_APPLICATION_POPUP_APPLICATION_ADD_BTN =
  ...
  // invitation member
  public static final String
          ELEMENT_SPACE_INVITED_USER_TABLE =
          ".//*[@id='UISpaceMember']//th[contains(text(),'Invited')]/../../..//*[contains(text(),'${user}')]";

  public static final String
          ELEMENT_SPACE_MEMBERS_USER_TABLE =
  ...
  public static final String
          ELEMENT_SPACE_INVITE_USERS_FROM_GROUP_SELECT_GROUP =
  ...
  public static final String
          ELEMENT_SPACE_NAVIGATION_NODE_POSITION =
  ...
  public static final String
          ELEMENT_SPACE_ACCESS_SPACE_REQUEST_JOIN_MESSAGE =
          ".//*[contains(text(),'You must be a member of the space')]//b[contains(text(),'$space')]/../..//*[contains(.,'to view this page')]";

  // message
  public static final String ELEMENT_SPACE_NAVIGATION_COPY_AT_SAME_LEVEL = "This node name already exists.";

  // Warining popup
  public static final String
          ELEMENT_SPACE_WARNING_MESSAGE =
  ...
  public static final String
          ELEMENT_SPACE_NAVIGATION_ADD_NODE_LIST =
          ".//*[@id='UISpaceNavigationNodeSelector']//*[contains(text(),'${name}')]";

  public static final String
          ELEMENT_SPACE_NAVIGAION_ADD_NODE_CHILDREN_UNDER_PARENT =
  ...
  // Space portlets
  public static final By ELEMENT_SPACE_MY_SPACE_PORTLET = By.id("UIMySpacesPortlet");

  public static final By ELEMENT_SPACE_ALL_SPACE_PORTLET = By.id("UIAllSpacesPortlet");

  public static final By ELEMENT_SPACE_INVITATION_SPACE_PORTLET =
          By.id("UIInvitationSpacesPortlet");

  public static final By ELEMENT_SPACE_PENDING_SPACE_PORTLET = By.id("UIPendingSpacesPortlet");
  ...
  public static final By ELEMENT_SPACE_VISIBILITY_HIDDEN_CHECKBOX = By.xpath("//*[@value='hidden']");

  public static final By ELEMENT_SPACE_REGISTRATION_OPEN_CHECKBOX = By.xpath("//*[@value='open']");

  public static final By ELEMENT_SPACE_REGISTRATION_CLOSED_CHECKBOX = By.xpath("//*[@value='close']");
  ...
  public static final String
          ELEMENT_DELETE_APP_FROM_TOPBAR =
  ...
  public static final String
          ELEMENT_SPACE_SELECT_USER_IN_FORM =
          "//*[@id='UIListUsers']//*[contains(text(),'{$name}')]/../..//*[@class='uiCheckbox']//input";

  // CONNECTION REQUEST
  public static final String
          ELEMENT_NOTIFICATION_EMAIL_FEEDBACK_MESSAGE_SPACE =
  ...
  // left menu
  public static final String
          ELEMENT_SPACE_LEFT_MENU_SPACE_NAME =
