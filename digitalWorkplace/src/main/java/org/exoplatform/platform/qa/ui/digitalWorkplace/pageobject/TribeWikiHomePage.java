...
public class TribeWikiHomePage {
     ...
     */
    public TribeWikiHomePage(TestBase testBase) {
    ...
    public void goToAddBlankPage() {
        ...
        homePagePlatform.refreshUntil($(ELEMENT_ADD_PAGE_TRIBE),Condition.visible,Configuration.openBrowserTimeoutMs);
     ...
     * Go to "Add blank wiki page"
     */
    public void goToAddBlankPageDW() {
        info("--Go to add blank wiki page--");
        homePagePlatform.refreshUntil($(ELEMENT_ADD_PAGE_DW),Condition.visible,Configuration.openBrowserTimeoutMs);
        $(ELEMENT_ADD_PAGE_DW).waitUntil(Condition.visible,Configuration.openBrowserTimeoutMs).click();
        $(ELEMENT_BLANK_PAGE_LINK).waitUntil(Condition.visible,Configuration.openBrowserTimeoutMs).click();
        info("Blank wiki page is shown");
    }
    ...
    public void goToAddTemplateWikiPageDW() {
        info("--Go to add blank wiki page--");
        homePagePlatform.refreshUntil($(ELEMENT_ADD_PAGE_DW),Condition.visible,Configuration.openBrowserTimeoutMs);
        $(ELEMENT_ADD_PAGE_DW).waitUntil(Condition.visible,Configuration.openBrowserTimeoutMs).click();
        $(ELEMENT_FROM_TEMPLATE_LINK).waitUntil(Condition.visible,Configuration.openBrowserTimeoutMs).click();
        info("Blank wiki page is shown");
    }
    ...
    public void deleteWiki(String title) {
        ...
        $(ELEMENT_DELETE_LINK_TRIBE).waitUntil(Condition.visible,Configuration.openBrowserTimeoutMs).click();
        $(ELEMENT_CONFIRM_WIKI_DELETE_TRIBE).waitUntil(Condition.visible,Configuration.openBrowserTimeoutMs).click();
        $(byText(title)).waitUntil(Condition.not(Condition.exist),Configuration.openBrowserTimeoutMs);

    }

    public void deleteWikiDW(String title) {
        homePagePlatform.refreshUntil($(byText(title)),Condition.visible,1000);
        info("Select the wiki page to delete");
        selectAPage(title);
        info("Click on More link");
        $(ELEMENT_MORE_LINK).waitUntil(Condition.visible,Configuration.openBrowserTimeoutMs).click();
        $(ELEMENT_DELETE_WIKI_PAGE_DW).waitUntil(Condition.visible,Configuration.openBrowserTimeoutMs).click();
        $(ELEMENT_CONFIRM_WIKI_PAGE_DELETE_DW).waitUntil(Condition.visible,Configuration.openBrowserTimeoutMs).click();
        $(byText(title)).waitUntil(Condition.not(Condition.exist),Configuration.openBrowserTimeoutMs);
