...
@Tag("sniff")
@Tag("task")
public class TaskInCalendar extends Base {
    ...
    public void test01_AddTaskInSpace() {
        ...
        taskManagement.inputDataTaskInQuickForm(taskName,
                ContentTask ,
                getDate(0, "MM/dd/yyyy"),
                getDate(0, "MM/dd/yyyy"),
                false);
        taskManagement.inputFromToQuickTask(null, null, true);
        taskManagement.saveQuickAddTask();
