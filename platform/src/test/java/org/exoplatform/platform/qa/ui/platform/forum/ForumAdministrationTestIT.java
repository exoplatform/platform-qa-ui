...
public class ForumAdministrationTestIT extends Base {
   ...
   * management screen is shown. Step number: 2 Step Name: Add BB Code Step
   * Description: - Click on Add BBCode - Enter data into fields - Save Input
   * Data: Expected Outcome: BB code is added successfully
   */

  @Test
  public void test03_EditBBCode() {
    info("Test 2: Add BB code");
    info("Create data test");
    String tag = "tag" + getRandomNumber();
    String replacement = "<b>{param}</b>.";
  ...
  @Test
  public void test04_DeleteBBCode() {
    info("Test 2: Add BB code");
    info("Create data test");
    String tag = "tag" + getRandomNumber();
    String replacement = "<b>{param}</b>.";
