...
public class ChatOnSiteNotificationTestIT extends Base {
  ...
  @Test
  @Tag(("c"))
  public void test01_CheckOnSiteNotificationWhenSendingMessageInRoomThenWhenSendingEmoticonsThenWhenStartingMeetingThenWhenStopMeetingThenWhenStatusIsDONotDisturb() {
    ...
    homePagePlatform.goToChat();
    switchTo().window(1);
    info("Check On Site Notification When Sending Emoticons");
    ...
    homePagePlatform.goToChat();
    switchTo().window(1);
    info("Check On Site Notification When Start Meeting");
    ...
    switchTo().window(1);
    sleep(2000);
    info("Check On Site Notification When Stop Meeting");
    roomManagement.startStopmeeting(room);
    switchToParentWindow();
    manageLogInOut.signOut();
    manageLogInOut.signInCas(username, password);
    ...
    manageLogInOut.signOut();
    manageLogInOut.signInCas(PLFData.DATA_USER1, PLFData.DATA_PASS2);
    info("Check On Site Notification When Status Is DO Not Disturb");
  ...
  @Test
  @Tag("cab")
  public void test02_CheckDoNotDisturbThenDesktopThenBipsThenOnSiteNotificationButtonThenCheckMaximumOfUnreadMessage() {
    String room = "room" + getRandomNumber();
    ...
    homePagePlatform.goToChat();
    info("Check DO Not Disturb Notification Button");
    switchTo().window(1);
    refresh();
    sleep(2000);
    ...
    ELEMENT_CHAT_SETTING_NOTIFICATION.waitUntil(Condition.visible, Configuration.openBrowserTimeoutMs).click();
    ELEMENT_CHAT_DO_NOT_DISTURB_BUTTON_NOTIFICATION.parent().waitUntil(Condition.visible, Configuration.openBrowserTimeoutMs);
    assertEquals("OFF", ELEMENT_CHAT_DO_NOT_DISTURB_BUTTON_NOTIFICATION.parent().getText());
    ELEMENT_CHAT_CONFIRM_BUTTON_NOTIFICATION.waitUntil(Condition.visible, Configuration.openBrowserTimeoutMs).click();
    info("Check Desktop Notification Button");
    ...
    info("Check Bips Notification Button");
    ...
    ELEMENT_CHAT_CONFIRM_BUTTON_NOTIFICATION.click();
    info("Check On Site Notification Button");
    ...
    ELEMENT_CHAT_CONFIRM_BUTTON_NOTIFICATION.click();
    info("Check Maximum Of Unread Message");
    refresh();
    switchToParentWindow();
    navigationToolbar.goToAddUser();
    userAddManagement.addUser(username, password, email, FirstName, LastName);
