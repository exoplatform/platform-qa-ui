...
public class SOCNotificationIntranetConnectionRequestTestIT extends Base {
  ...
  public void Test01_CheckConnectionRequestNotification() {
    ...
    /*
     * Check Connection Request notification - The notification
     * "Someone sends me a connection request" is activated in User Settings - User
     * A sent a connection request to User B Step 1 - Login with User B - Click the
     * notifications icon - Check the notification list
     */
    ...
    /**
     * Step 2 - Check the notification message --> Expected result: The notification
     * message is : - $AVATAR - $USER wants to connect with you - $DATE - 2 actions
     * : [Accept] | [Refuse] Where : - $AVATAR is thumbnail of User A - $USER is
    ...
    /**
     * Step 3: - Click the notification area --> Expected: User B is redirected to
     * the profile of User A
     */
    ...
    $(byXpath(ELEMENT_PROFILE_TITLE.replace("${fullName}", username1 + " " + username1))).waitUntil(Condition.visible,
  ...
  public void Test02_AcceptAConnectionRequestFromTheNotification() {
    ...
    /**
     * Accept a Connection Request from the notification - The notification "Someone
     * sends me a connection request" is activated in User Settings - User A sent a
     * connection request to User B - Login with User B - Click notifications icon -
     * Check the list Step 2: Click on Accept --> Expected: - The connection is
     * approved, the 2 users are connected
     */
    String username1 = "usernamea" + getRandomString();
    String email1 = username1 + "@gmail.com";
    String username2 = "usernameb" + getRandomString();
    ...
    /**
     * Step 3: - Check the notification message --> Expected: After clicking Accept,
     * the notification message is updated to : $AVATAR You are connected with $USER
     * $DATE Where : - $AVATAR is thumbnail of User A - $USER is User A - $DATE is
    ...
    /**
     * Step 4: - Click the notification area --> Expected:- User B is redirected to
     * the profile of User A
     */
    navigationToolbar.goToIntranetNotification();
  ...
  public void Test03_RefuseAConnectionRequestFromTheNotification() {
    ...
    /**
     * Refuse a Connection Request from the notification - The notification "Someone
     * sends me a connection request" is activated in User Settings - User A sent a
     * connection request to User B - Login with User B - Click notifications icon -
     * Check the list - Click [Refuse] --> Expected: - The connection is not
     * approved, the 2 users are not connected - The notification message is
     * automatically hidden from the list - Go to View All page --> Expected: - The
     * notification is not available / displayed in the View All page
     */
    String username1 = "usernamea" + getRandomString();
    String email1 = username1 + "@gmail.com";
    String username2 = "usernameb" + getRandomString();
  ...
  public void Test04_CheckViewAllAfterAcceptingAConnectionRequest() {
    ...
    /*
     * Check View All after accepting a Connection Request Precondition: - The
     * notification "Someone sends me a connection request" is activated in User
     * Settings - User A sent a connection request to User B Step 1: - Login with
     * User B - Click notifications icon - Check the list - Click [Accept] -->
     * Expected: - The connection is approved, the 2 users are connected - The
     * notification message is updated accordingly
     */
    String username1 = "usernamea" + getRandomString();
    String email1 = username1 + "@gmail.com";
    String username2 = "usernameb" + getRandomString();
    ...
    intranetNotification.checkStatus(status, username1);
    /**
     * Step 2: - Go to View All --> Expected: - The notifications is displayed in
     * the message - The message is displayed at the same position as the connection
     * request
     */
    info("The notification is not available / displayed in the View All page");
    navigationToolbar.goToIntranetNotification();
  ...
  public void Test05_CheckViewAllAfterrefusingAConnectionRequest() {
    ...
    /**
     * Check View All after refusing a Connection Request - The notification
     * "Someone sends me a connection request" is activated in User Settings - User
     * A sent a connection request to User B - Login with User B - Click
     * notifications icon - Check the list - Click [Refuse] - Go to View All -->
