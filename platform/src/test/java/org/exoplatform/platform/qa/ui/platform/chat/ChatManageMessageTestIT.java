...
public class ChatManageMessageTestIT extends Base {
  ...
  public void test02_uploadFileInSpaceChatThenUserChat() {
    ...
    ELEMENT_CONTAINER_ACTIVITY.waitUntil(Condition.visible,Configuration.timeout).find(byAttribute("data-original-title", "eXo-Platform.png")).should(Condition.exist);
    sleep(Configuration.timeout);
    homePagePlatform.goToMySpaces();
