...
public class WikiSearchTestIT extends Base {
  ...
  @Test
  public void test03_SearchTemplateAdvancedSearchWithExistPage() {
    ...
    wikiHomePage.goTosearchPage(wiki1);
    info("Verify that search page is shown with the text");
    $(byClassName("resultInfo")).find(byText(wiki1)).should(Condition.exist);
