...
public class SOCNotificationIntranetNotificationIconTestIT extends Base {
   ...
   */
  /*
   * Step Number: 1 Step Name: Step Description: - Login to platform Input Data:
   * Expected Outcome: - The homepage is displayed
   */

  /*
   * Step number: 2 Step Name: Step Description: - Check the top navigation Input
   * Data: Expected Outcome: - The Notifications icon is displayed in the top
   * navigation, next to the profile menu
   */
  @Test
   ...
   * <li>Test Case Name: New notifications number is displayed next to the
   * icon.</li>
   * <li>Pre-Condition: The user has unread notifications (no matters the
   * notification type), for instance 3 notifications</li>
   * <li>Post-Condition:</li>
   */
  /*
   * Step Number: 1 Step Name: Step Description: - Login to platform - Check the
   * top navigation Input Data: Expected Outcome: - The number of new
   * notifications (3 notifications) is displayed above the icon with a blue
   * badge.
   */
  @Test
   ...
   * <li>Test Case Name: Open the notifications list to reset the number of
   * notifications.</li>
   * <li>Pre-Condition: The user has unread notifications (no matters the
   * notification type), for instance 3 notifications</li>
   * <li>Post-Condition:</li>
   ...
   */
  /*
   * Step number: 2 Step Name: Step Description: - Click the notification icon
   * Input Data: Expected Outcome: - The list opens - When opening the
   * notification list, the number of new notifications displayed in the badge is
   * reset.
   */
  @Test
  public void test03_OpenTheNotificationsListToResetTheNumberOfNotifications() {
    ...
    $(byXpath(ELEMENT_BADGE_NUMBER_DISPLAY.replace("${number}", "3"))).waitUntil(Condition.not(Condition.visible),
