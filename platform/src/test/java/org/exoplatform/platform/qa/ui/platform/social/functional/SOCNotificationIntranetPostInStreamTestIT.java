...
public class SOCNotificationIntranetPostInStreamTestIT extends Base {
   ...
   * - The notification "Someone posts a message on my activity stream" is
   ...
   * Stream notifications is displayed in the list
   */
   ...
   * The notification message is :$AVATAR$USER has posted on your activity
   * stream$ACTIVITY$DATEWhere : - $AVATAR is the thumbnail of User A - $USER is
   * User A - $ACTIVITY is the activity title / message - $DATE is the date of the
   * notification
   */
  @Test
   ...
   * Go to View All Input Data: Expected Outcome: - Post of my Stream notification
