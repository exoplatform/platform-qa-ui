...
public class SOCPeopleProfileConnectionTestIT extends Base {
  ...
  public void test03_CheckMyConnectionsSection() {
    ...
    info("Test 2: Check my Connections section");
    ...
    $(byId("tiptip_content")).find(byText(userList.get(11) + " " + userList.get(11))).waitUntil(Condition.visible,Configuration.openBrowserTimeoutMs);
    ...
    info("Test 3: Check the Connections section of another user.");
