...
public class PlfUnifiedSearchTestIT extends Base {
  ...
  public void test04_FilterSearch() {
    ...
    refresh();
    navigationToolbar.goToQuickSearch();
    $(ELEMENT_TOOLBAR_QUICKSEARCH_TEXTBOX).waitUntil(Condition.visible, Configuration.timeout).click();
    $(ELEMENT_TOOLBAR_QUICKSEARCH_TEXTBOX).waitUntil(Condition.visible, Configuration.timeout).setValue(wiki);
    ELEMENT_QUICKSEARCHRESULT_SEE_ALL_SEARCH.waitUntil(Condition.visible, Configuration.timeout).click();
    $(ELEMENT_SEARCHRESULT_ALLTYPECHECK).waitUntil(Condition.visible, Configuration.timeout).click();
    $(ELEMENT_SEARCHRESULT_WIKITYPECHECK).waitUntil(Condition.visible, Configuration.timeout).click();
  ...
  public void test06_AdministrateTheUnifiedSearchEngine() {
    ...
    $(ELEMENT_TOOLBAR_QUICKSEARCH_TEXTBOX).waitUntil(Condition.visible,Configuration.timeout).setValue(wiki);
    ELEMENT_DROP_DOWN_LIST_RESULT_IN_QUICK_SEARCH.waitUntil(Condition.visible, Configuration.timeout);
    $(ELEMENT_TOOLBAR_QUICKSEARCH_TEXTBOX).waitUntil(Condition.visible,Configuration.timeout).pressEnter();
    info("Verify that File checkbox is not shown");
    $(ELEMENT_SEARCHRESULT_WIKITYPECHECK).waitUntil(Condition.visible,Configuration.timeout).shouldNot(Condition.exist);
    navigationToolbar.goToAdminSearch();
    $(ELEMENT_SEARCH_ADMINISTRATION_COLUMMN_TYPE_TITLE).waitUntil(Condition.appears, Configuration.timeout).click();
    info("Click on Enable button");
    $(byId("wiki")).waitUntil(Condition.appears, Configuration.timeout).click();
    info("Open Search page");
    navigationToolbar.goToQuickSearch();
    $(ELEMENT_TOOLBAR_QUICKSEARCH_TEXTBOX).waitUntil(Condition.appears, Configuration.timeout).setValue(wiki);
    ELEMENT_DROP_DOWN_LIST_RESULT_IN_QUICK_SEARCH.waitUntil(Condition.visible, Configuration.timeout);
    $(ELEMENT_TOOLBAR_QUICKSEARCH_TEXTBOX).waitUntil(Condition.appears, Configuration.timeout).pressEnter();
  ...
  public void test07_SearchFiles() {
    ...
    $(ELEMENT_TOOLBAR_QUICKSEARCH_TEXTBOX).waitUntil(Condition.visible,Configuration.timeout).pressEnter();
    $(ELEMENT_SEARCHRESULT_ALLTYPECHECK).waitUntil(Condition.visible,Configuration.timeout).click();
    $(ELEMENT_SEARCHRESULT_FILESTYPECHECK).waitUntil(Condition.visible,Configuration.timeout).click();
