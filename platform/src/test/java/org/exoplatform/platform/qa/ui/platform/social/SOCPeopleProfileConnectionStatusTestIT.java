...
public class SOCPeopleProfileConnectionStatusTestIT extends Base {
  ...
  public void test01_CheckConnectionStatusBetweenTwoUsers() throws Exception {
    ...
    $(ELEMENT_UIMINICONNECTIONS_PORLET_CONNECT_STATUS).click();
    $(ELEMENT_UIMINICONNECTIONS_PORLET_CANCEL_STATUS).waitUntil(visible, Configuration.timeout);
    ...
    $(ELEMENT_UIMINICONNECTIONS_PORLET_ACCEPT_STATUS).click();
    $(ELEMENT_UIMINICONNECTIONS_PORLET_CONNECTED_STATUS).waitUntil(visible, Configuration.timeout);

    $(ELEMENT_UIMINICONNECTIONS_PORLET_CONNECTED_STATUS).waitUntil(visible, Configuration.timeout).hover();
    $(ELEMENT_UIMINICONNECTIONS_PORLET_DISCONNECTED_STATUS).waitUntil(visible, Configuration.timeout);
