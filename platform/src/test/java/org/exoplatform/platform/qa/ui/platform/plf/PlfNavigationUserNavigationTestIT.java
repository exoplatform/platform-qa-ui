...
public class PlfNavigationUserNavigationTestIT extends Base {
  ...
  @Test
  public void test01_UserNavigateAnotherUsersPersonalPagesThenInHisOwnPersonalPages() {

    info("User navigate another user's personal pages");
   ...
   connectionsManagement.searchPeople(PLFData.DATA_USER2,"","","");
    ...
    info("User navigates in his own personal pages");
