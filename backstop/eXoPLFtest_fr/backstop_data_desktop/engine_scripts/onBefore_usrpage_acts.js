...
casper.then( function(){  
    casper.echo('Clicking useractivities button');
    casper.click('i.uiIconPLFActivityStream');
    casper.waitForSelector('div.desktop-input');
    casper.wait(4000);
    this.capture('C:/Backstopjs/Backstopjs Projects/DemoExo/backstop_data/user-action-screenshots/' + vp.name+'.png');
...
casper.then( function(){  
    casper.echo('Clicking useractivities button');
    casper.click('i.uiIconPLFActivityStream');
    casper.waitForSelector('div.composerHintCont');
    casper.wait(4000);
    this.capture('C:/Backstopjs/Backstopjs Projects/DemoExo/backstop_data/user-action-screenshots/' + vp.name+'.png');
