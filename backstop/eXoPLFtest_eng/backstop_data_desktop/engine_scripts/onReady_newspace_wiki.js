...
casper.then( function(){ 
    casper.echo('create spacefor wiki');
...
casper.thenOpen(scenario.url + "/portal/g/:spaces:test25/test25", function() {
...
casper.thenOpen(scenario.url + "/portal/g/:spaces:test25/test25/wiki", function() {
