...
casper.thenOpen(scenario.url + "/portal/g/:platform:administrators/searchIndexing", function() {
    casper.waitForSelector('#indexingManagement');
    casper.echo('Clicking search indexing button');
    casper.wait(4000);
    this.capture('C:/Backstopjs/Backstopjs Projects/DemoExo/backstop_data/user-action-screenshots/' + vp.name+'.png');
  });
