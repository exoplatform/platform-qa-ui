...
public class BaseTribe extends TestBase {
  ...
  public void afterEach() {
    ...
    if ($(USERNAME_TRIBE).is(Condition.not(Condition.visible))
            && $(PASSWORD_TRIBE).is(Condition.not(Condition.visible))) {
      manageLogInOut.signOutTribe();
      ELEMENT_TRIBE_VERTICAL_SIDEBAR_MENU.waitUntil(Condition.not(Condition.visible),Configuration.openBrowserTimeoutMs);
    }
