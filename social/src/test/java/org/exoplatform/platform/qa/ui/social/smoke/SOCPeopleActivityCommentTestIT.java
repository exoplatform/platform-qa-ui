...
public class SOCPeopleActivityCommentTestIT extends Base {
  ...
  public void test03_DeleteComment() {
    ...
    $(byXpath("//a[@id='${deleteButton}']/preceding::i[@class='uiIconActivityAction uiIconLightGray'][1]".replace("${deleteButton}", "DeleteCommentButtoncomment" + idComment.toString()))).waitUntil(Condition.visible,2000).click();
