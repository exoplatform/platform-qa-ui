...
public class SOC_HomePageTestIT extends Base {
  ...
  public void test01_LikeActivity() {
    ...
    /*
     * Step Number: 1 Step Name: Step 1: Like/Unlike Activity Step Description:
     * - Go to Intranet home - Click on Like activity in action bar part of an
     * activity Input Data: Expected Outcome: - Like button is highlighted and
     * the number of likers is updated
     */
     ...
     * liker is added into likes part, the oldest liker is displayed at the
     * right and the newest at the left. - Profile pictures of users popup
     */
  ...
  public void test02_15_AddDeleteComment() {
    ...
    /*
     * Step Number: 1 Step Name: Add comment for activity Step Description: - Go
     * to Intranet home - Select the activity - Click comment icon to show input
     * text field - input the comment and click comment Input Data: Expected
  ...
  public void test03_DeleteYourActivity() {
     ...
     * Intranet home - Select the activity - mouse over activity you want to
     * delete - Click the (x) icon to delete Input Data: Expected Outcome: -
     * Comment will be shown in comment section of activity - the (x) icon
     * display on the top -right of activity - activity is deteled successfully
     */
