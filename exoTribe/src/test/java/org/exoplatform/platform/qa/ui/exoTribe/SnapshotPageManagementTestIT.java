...
public class SnapshotPageManagementTestIT extends BaseTribe {
  ...
  public void test12_CheckTheUploadedDocumentsBehaviorInSpacesDocumentsWidgetByAnOtherUser() {
    ...
    homePagePlatform.goToMySpacesTribeViaUrl();
    tribeSpaceManagement.addNewSpaceTribe(spaceNameb, spaceDesb, "Open", "No", inviteUsers);
    ...
    Assert.assertNotEquals(ELEMENT_TRIBE_THIRD_EXPLORE_DOCUMENT_NAME.getText(), thirdAttachedFile);
    Assert.assertNotEquals(ELEMENT_TRIBE_THIRD_EXPLORE_DOCUMENT_SPACE_NAME.getText(), spaceNamea);
  ...
  public void test13_CheckTheUploadedDocumentsBehaviorInSharedWithMeDocumentsWidgetByAnOtherUser() {
    ...
    info("Click on Connect button to invite " + tribe_user3);
    ...
    info("Share the document with " + tribe_user3);
    tribeActivityStream.shareDocumentWithUser(inviteUsers);
