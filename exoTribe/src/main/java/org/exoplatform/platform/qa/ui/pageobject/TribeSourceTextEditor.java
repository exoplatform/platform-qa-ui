...
import static org.exoplatform.platform.qa.ui.selenium.locator.exoTribe.exoTribeLocator.ELEMENT_CONTENT_WIKI_INPUT_DW;
...
public class TribeSourceTextEditor {
  ...
  public void addSimplePageDW(String title, String content) {
    ...
    info("Input a content for the page");
    sleep(1000);
    $(ELEMENT_CONTENT_WIKI_INPUT_DW).waitUntil(Condition.visible,Configuration.openBrowserTimeoutMs).setValue(content);
  }
  ...
  public void editSimplePageDW(String newTitle, String newContent) {
    info("Input a title for the page");
    $(ELEMENT_TITLE_WIKI_INPUT).waitUntil(Condition.visible,Configuration.openBrowserTimeoutMs).clear();
    $(ELEMENT_TITLE_WIKI_INPUT).waitUntil(Condition.visible,Configuration.openBrowserTimeoutMs).sendKeys(newTitle);
    ...
    info("Input a content for the page");
    sleep(1000);
    $(ELEMENT_CONTENT_WIKI_INPUT_DW).waitUntil(Condition.visible,Configuration.openBrowserTimeoutMs).clear();
    $(ELEMENT_CONTENT_WIKI_INPUT_DW).waitUntil(Condition.visible,Configuration.openBrowserTimeoutMs).sendKeys(newContent);
